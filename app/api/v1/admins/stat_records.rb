    ...
    class StatRecords < Grape::API
      ...
      resources 'stat_records' do
        ...
        get '/' do
          ...
          date_headers, chart_data, table_data = Record.data params
          {date_headers: date_headers, chart_data: chart_data, able_data: paginate(Kaminari.paginate_array(table_data.to_a))}
        end
      end
    end
  end
